	...
	<div class=" row contenedor-header">
		...
		<div class="row ">
			...
			<!-- <a class="contacto-logo href="<?php $url = home_url(); echo $url; ?>"  >
				...
				<a href="<?php echo get_post_type_archive_link( 'valpa_trabajos_pt' ); ?>">Bolsa de trabajo</a>
	...
	<div class="row">
		<div class=" contenedor-logo ">
			...
			<?php endif;?>
				          ...
				          <img src="<?php bloginfo('template_url');?>/images/proxima/up.svg"  />
				        <!-- <img src="<?php bloginfo('template_url');?>/images/proxima/up.svg"class="valpa-blanco"  /> -->
